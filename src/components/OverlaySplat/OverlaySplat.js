...
class OverlaySplat extends Component {
  ...
  render() {
    ...
    const overlaySplatStyle = {
      ...
      left:
        makeWrapperDimensions.width / 2 +
        makeWrapperDimensions.offsetLeft -
        overlaySplatDimensions.width / 2 +
        'px',
    };
    ...
    return (
      <img
        ...
        ref={comp => this.setDimensions(comp)}
      />
    );
  }
}

export default observer(OverlaySplat);
